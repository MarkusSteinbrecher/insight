...
export const defaultThemes: ThemeDef[] = [
	...
	{ id: 'cool', name: 'Cool', icon: 'sparkles', light: {
		...
		'--color-source': '#0D9488', '--color-source-bg': '#CCFBF1',
		'--color-extract': '#475569', '--color-extract-bg': '#F1F5F9',
		'--color-claim': '#2563EB', '--color-claim-bg': '#EFF6FF',
		'--color-finding': '#7C3AED', '--color-finding-bg': '#F5F3FF',
		'--radius-sm': '0.5rem', '--radius-md': '0.75rem', '--radius-lg': '1rem', '--radius-full': '9999px',
	}, dark: {
		...
		'--color-source': '#5EEAD4', '--color-source-bg': '#0F2D2A',
		'--color-extract': '#94A3B8', '--color-extract-bg': '#1E293B',
		'--color-claim': '#60A5FA', '--color-claim-bg': '#172136',
		'--color-finding': '#A78BFA', '--color-finding-bg': '#1E1536',
		'--radius-sm': '0.5rem', '--radius-md': '0.75rem', '--radius-lg': '1rem', '--radius-full': '9999px',
	}},
	{ id: 'yello', name: 'Yello', icon: 'zap', light: {
		...
		'--color-source': '#D97706', '--color-source-bg': '#FEF3C7',
		'--color-extract': '#4D7C0F', '--color-extract-bg': '#ECFCCB',
		'--color-claim': '#EA580C', '--color-claim-bg': '#FFF7ED',
		'--color-finding': '#BE123C', '--color-finding-bg': '#FFF1F2',
		'--radius-sm': '0.5rem', '--radius-md': '0.75rem', '--radius-lg': '1rem', '--radius-full': '9999px',
	}, dark: {
		...
		'--color-source': '#FCD34D', '--color-source-bg': '#2A2710',
		'--color-extract': '#A3E635', '--color-extract-bg': '#1A2E0A',
		'--color-claim': '#FB923C', '--color-claim-bg': '#2E1A0A',
		'--color-finding': '#FB7185', '--color-finding-bg': '#2E0A14',
		'--radius-sm': '0.5rem', '--radius-md': '0.75rem', '--radius-lg': '1rem', '--radius-full': '9999px',
	}},
];
